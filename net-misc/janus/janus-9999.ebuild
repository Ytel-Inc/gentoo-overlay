...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="websockets rabbitmq mqtt debug docs opus ogg data-channels plugin-audiobridge plugin-recordplay plugin-sip plugin-videoroom plugin-voicemail post-processing plugin-videocall plugin-lua"
